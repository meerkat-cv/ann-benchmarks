...
# A tibble: 6 x 13
  ...
  <chr>             <dbl> <chr>     <chr>      <chr>                            
1 vgg-512-euclidean    10 euclidean kd         KDTree(leaf_size=30)             
2 vgg-512-euclidean    10 euclidean bruteforce BruteForce()                     
3 vgg-512-euclidean    10 euclidean NGT-onng   ONNG-NGT(100, 10, 120, -2, 1.200)
4 vgg-512-euclidean    10 euclidean NGT-onng   ONNG-NGT(100, 10, 120, -2, 0.900)
5 vgg-512-euclidean    10 euclidean NGT-onng   ONNG-NGT(100, 10, 120, -2, 1.050)
6 vgg-512-euclidean    10 euclidean NGT-onng   ONNG-NGT(100, 10, 120, -2, 1.100)
  `knn-dist` `knn-set` `accuracy-R@1` `accuracy-R@10`       qps queryTime
       <dbl>     <dbl>          <dbl>           <dbl>     <dbl>     <dbl>
1     1         1              0.0982          0.0989     0.262 3.82     
2     1         1              0.196           0.197      0.303 3.30     
3     1.00      1.00           0.973           0.984     39.4   0.0254   
4     0.0618    0.0609         0.0989          0.0995 12330.    0.0000811
5     0.571     0.569          0.560           0.566   1255.    0.000797 
6     0.998     0.997          0.973           0.983    716.    0.00140  
    build indexsize
    <dbl>     <dbl>
1  539.     1073868
2    1.11         0
...
|-------------------+------------------------------------------------------------------------------------------+---------+-----------+----------+----------|
| bruteforce-sk     | BruteForce()                                                                             |       1 |      0.02 |  3304.93 |        0 |
...
|-------------------+------------------------------------------------------------------------------------------+---------+----------+-----------+----------|
| bruteforce-sk     | BruteForce()                                                                             |       1 |  3304.93 |      0.02 |        0 |
